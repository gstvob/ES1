...
public class TableGUI{
	...
	public void cardsGui(JPanel _panel, int length ,String card1, String card2) {
		panel = _panel;
		int posx = 140, posy = 360;
		System.out.println("PRINT DAS CARTAS PARA GUI: "+card1+ ", "+card2);
		cards = new JLabel[length*2 + 2];
		
		carta1 = new JLabel(new ImageIcon("/home/gustavob/workspace/Poker/src/images/"+card1));
		carta2 = new JLabel(new ImageIcon("/home/gustavob/workspace/Poker/src/images/"+card2));
